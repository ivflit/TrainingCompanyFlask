...
from microservices.trainer_service import app
...
class TrainerServiceTestCase(unittest.TestCase):
    ...
    @patch('app.trainers_table.get_item')
    ...
    @patch('app.trainers_table.put_item')
    @patch('app.trainers_table.scan')
    ...
    @patch('app.trainers_table.delete_item')
